...
import DeleteTVShowCategoryComponent from '../../Components/Admin/DeleteTVShowCategoryComponent';
import { useLazyQuery, useMutation } from '@apollo/client';
import { DELETE_TVSHOW_CATEGORY } from '../../GraphQL/Apollo-Client/Mutations/TVShowCategoryMutation';
...
function DeleteTVShowCategory() {
  const router = useRouter();
  const toast = useToast();

  const [name, setName] = useState('');

  const [deleteTVShowCategory, { data: deleteTVShowCategoryData }] =
    useMutation(DELETE_TVSHOW_CATEGORY);
  ...
  return (
    <Box>
      ...
      <DeleteTVShowCategoryComponent
        toast={toast}
        deleteTVShowCategory={deleteTVShowCategory}
        deleteTVShowCategoryData={deleteTVShowCategoryData}
        name={name}
        setName={setName}
      />
    </Box>
...
export default DeleteTVShowCategory;
