...
import DeleteMovieComponent from '../../Components/Admin/DeleteMovieComponent';
import { useLazyQuery, useMutation } from '@apollo/client';
import { DELETE_MOVIE } from '../../GraphQL/Apollo-Client/Mutations/MovieMutation';
...
function DeleteMovie() {
  ...
  const [deleteMovie, { data: deleteMovieData }] = useMutation(DELETE_MOVIE);
